...
export default function NovaRequisicaoPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await requisitionsAPI.criar(formData);
                ...
                <div className="flex">
                  ...
                  <div className="text-sm text-yellow-700">
                    ...
                    <ul className="mt-1 list-disc list-inside">
                      <li>Requisições urgentes devem ser justificadas adequadamente</li>
                      <li>Verifique a disponibilidade do material antes de solicitar</li>
                      <li>O prazo de aprovação pode variar conforme a prioridade</li>
                    </ul>
                  </div>
                </div>
              </div>
